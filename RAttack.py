...
for r_p in range(2,11):
    print("attack random"+" "+str( float(r_p/10.0)))
    node_contacts=[]
    #print (node_contacts)
    ...
    ran_num = (random.randint(0, len(t.nodes) - 1))
    ...
    e_po = distance_count2(len(t.nodes) , new_node_contacts, active_nodes_list1, active_nodes_list_time1)
    ...
    plik2.write('\n')
    plik2.write( "r" + '\t' + str(r_p) + '\t' + str(len(t.nodes)) + '\t'
